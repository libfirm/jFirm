...
public class binding_irnode {
	...
	public static native void remove_End_n(Pointer end, int idx);
	...
	public static native int is_x_except_Proj(Pointer node);

	public static native int is_x_regular_Proj(Pointer node);

	public static native void ir_set_throws_exception(Pointer node, int throws_exception);

	public static native int ir_throws_exception(Pointer node);
	...
	public static native com.sun.jna.NativeLong get_ASM_n_constraints(Pointer node);

	public static native com.sun.jna.NativeLong get_ASM_n_clobbers(Pointer node);
	...
	public static native Pointer ir_new_switch_table(Pointer irg, com.sun.jna.NativeLong n_entries);
