...
public class binding_irdom {
	...
	public static native Pointer get_Block_ipostdom(Pointer block);
	...
	public static native Pointer get_Block_dominated_first(Pointer block);

	public static native Pointer get_Block_postdominated_first(Pointer bl);

	public static native Pointer get_Block_dominated_next(Pointer node);
	...
	public static native void postdom_tree_walk(Pointer n, Pointer pre, Pointer post, Pointer env);

	public static native void dom_tree_walk_irg(Pointer irg, Pointer pre, Pointer post, Pointer env);

	public static native void postdom_tree_walk_irg(Pointer irg, Pointer pre, Pointer post, Pointer env);
	...
	public static native java.nio.Buffer ir_get_dominance_frontier(Pointer block);
}
