...
public class binding_ircons {
	...
	public static native Pointer new_rd_DivRL(Pointer db, Pointer block, Pointer memop, Pointer op1, Pointer op2, int pinned);

	public static native Pointer new_r_DivRL(Pointer block, Pointer memop, Pointer op1, Pointer op2, int pinned);

	public static native Pointer new_d_DivRL(Pointer db, Pointer memop, Pointer op1, Pointer op2, int pinned);
